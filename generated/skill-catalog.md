...
> Generated: 2026-03-11T21:25:31.164Z
> Skills: 47
...
| `middleware.ts` | `investigation-mode` (8), `auth` (6), `routing-middleware` (6), `edge-runtime` (4) |
| `middleware.js` | `investigation-mode` (8), `auth` (6), `routing-middleware` (6), `edge-runtime` (4) |
| `src/middleware.ts` | `investigation-mode` (8), `auth` (6), `routing-middleware` (6), `edge-runtime` (4) |
